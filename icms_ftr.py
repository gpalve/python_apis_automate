...
try:
    for single_date in daterange(start_date,end_date):
        ...
        url_interchange_data = (env.master_url+'UCCC-API/subApis/icms.php?reportType=FtrCount&fromDate='+x+'&toDate='+x)
    ...
    #Example: conn = create_engine("mysql+pymysql://root:PassWord123!@localhost/my_database")
        ...
        df.to_sql(name='icms_ftr_count', con=conn, if_exists = 'append', index=False)
        mydate = []
