...
try:
    ...
    # for single_date in daterange(start_date, end_date):
        ...
        url_interchange_data = (env.master_url+'UCCC-API/subApis/fois_new.php?apiType=stblyrdgsped&custDate='+x)
    ...
    #Example: conn = create_engine("mysql+pymysql://root:PassWord123!@localhost/my_database")
        ...
        df.to_sql(name='fois_yard_speed_data', con=conn, if_exists = 'append', index=False)
        mydate = []
