...
try:
    for single_date in daterange(start_date,end_date):
        ...
        url_interchange_data = (env.master_url+'UCCC-API/subApis/fois_new.php?apiType=pndgindt&custDate='+x)
        ...
        try:
            finalData = json.loads(json.dumps(response.json()))
        except ValueError:
        ...
        # print(df2)
            ...
            print("key error")
        # df = pd.json_normalize(finalData)
    ...
    #Example: conn = create_engine("mysql+pymysql://root:PassWord123!@localhost/my_database")
        ...
        df.to_sql(name='fois_indent_data', con=conn, if_exists = 'append', index=False)
        mydate = []
